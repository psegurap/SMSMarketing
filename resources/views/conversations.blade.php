                    ...
                    <div class="user-list-box">
                        ...
                        <div class="people">
                            ...
                            @foreach ($contacts as $key => $contact)
                                <div class="person" data-chat="contact{{$contact['id']}}">
                                    <div class="user-info">
                                        <div class="f-head">
                                        ...
                                        <div class="f-body">
                                            <div class="meta-info">
                                                <span class="user-name" data-name="Nia Hillyer">{{$contact['first_name']}} {{$contact['last_name']}}</span>
                                                <span class="user-meta-time">{{$contact['conversations'][count($contact['conversations']) - 1]['created_at']}}</span>
                                            </div>

                                            @for ($i = 0; $i < 1; $i++)
                                                <span class="preview">{{$contact['conversations'][count($contact['conversations']) - 1]['text_details']}}</span>
                                            @endfor
                        ...
                        <div class="chat-box-inner">
                            ...
                            <div class="chat-conversation-box">
                                <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                    ...
                                    @foreach ($contacts as $key => $contact)
                                        <div class="chat" data-chat="contact{{$contact['id']}}">
                                            ...
                                            <div class="bubble {{$conversation['type'] == 'send' ? 'me' : 'you'}}">
                                                {{$conversation['text_details']}}
                                            </div>
                                            @endforeach
