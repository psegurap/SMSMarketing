...
@section('styles')
<link href="{{asset('cork/assets/css/apps/mailing-chat.css')}}" rel="stylesheet" type="text/css" />
<style>
...
@endsection
@section('page_name')
<li class="breadcrumb-item active" aria-current="page"><span>Conversations</span></li>
@endsection
    ...
    <div class="chat-section layout-top-spacing">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div id="ChatList-ConversationDetails" class="chat-system">
                        ...
                        <div class="people">
                            <div v-for="contact in contacts" @click=OpenChat(contact) class="person" :data-chat="contact.id">
                                <div class="user-info">
                                    <div class="f-body">
                                        <div class="meta-info">
                                            <span class="user-name" data-name="Sean Freeman">@{{contact.first_name}} @{{contact.last_name}}</span>
                                            <span class="user-meta-time">@{{contact.conversations[contact.conversations.length - 1]['created_at']}}</span>
                                        </div>
                                        <span class="preview">@{{contact.conversations[contact.conversations.length - 1]['text_details']}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="chat-box">
                        ...
                        <div class="chat-box-inner">
                            <div class="chat-meta-user">
                                <div class="current-chat-user-name"><span><span class="name"></span></span></div>
                            ...
                            <div class="chat-conversation-box">
                                <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                    ...
                                    <div v-for="contact in contacts" class="chat" :data-chat="contact.id">
                                        <div v-for="text in contact.conversations" class="bubble" :class="text.type == 'send' ? 'me' : 'you'">
                                            @{{text.text_details}}
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
<script src="{{asset('js/libraries/vue.js')}}"></script>
<script src="{{asset('js/conversations.js')}}"></script>
<script src="{{asset('cork/assets/js/apps/mailbox-chat.js')}}"></script>
